...
class City extends React.Component {
  ...
  addLocation = () => {
    ...
    addLocation(location, "city", city);
  ...
  render() {
    ...
    return (
      <View style={{ flex: 1 }}>
        <ScrollView
          contentContainerStyle={[!updatedCity.currencies.length && { flex: 1 }]}
        >
          <View
            style={[
              styles.currenciesContainer,
              !updatedCity.currencies.length && {
                flex: 1,
          ...
          >
            ...
            {updatedCity.currencies.map((location, index) => (
